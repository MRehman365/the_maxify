...
export const IndustriesData = [
  {
    ...
    descriptionMobile: "Build scalable, agile retail and e-commerce stores that increase sales, customer loyalty, and business ROI with Maxify Web Solutions, a multi-award-winning e-commerce development agency. With more than 5 years of implementation experience and strong combination of strategic partnerships with various clients we provide the greatest innovation and customization for B2B, B2C, and B2B2C business models. Globally, we serve as the trusted e-commerce partner of choice for some of the largest retail and e-commerce brands, reinventing e-retail and transforming data into actionable strategies to help customers across all touchpoints. We're helping you improve your experience.",
    description2:
      "Our custom retail & eCommerce consulting services help elevate your CX.",
    industriesSubData: [
      {
  ...
  },
  {
    ...
    description1:
      ...
      descriptionMobile:"Maxify web Solutions stands as a pioneer in the healthcare industry by providing ample solutions and services. We develop robust applications, software that are deep-rooted in facilitating solutions that transform the healthcare industry and make it user-friendly. Our healthcare solutions are scalable, secure, responsive, and structured to meet the unique needs of clients. Our goal has always been to enhance the system and get advanced technology that can fuse well with the healthcare system to incubate technical advancement and steadiness in the operation. We work together with high-ranking software producers and vendors to ensure that novel frontal projects are implemented in various medical care areas.",
      description2:
  ...
  },
  {
    ...
    description1:
      ...
      descriptionMobile:  "In today's digital age, traditional methods of teaching and learning are evolving, and we're at the forefront of this transformation. Our mission is to empower educators, students, and institutions with cutting-edge educational solutions that enhance learning outcomes and drive innovation. We understand the diverse needs of the education sector. We offer a comprehensive suite of services tailored to meet the unique requirements of our clients. Our team of experienced developers, designers, and educational experts works closely with clients to understand their goals and objectives. We leverage the latest technologies and methodologies to deliver high-quality solutions that are scalable, user-friendly, and cost-effective. From mobile apps to web platforms, we provide end-to-end development services that optimize the learning experience for all stakeholders.",
      description2:
      "Our custom retail & Health Care services help elevate your CX.",
    industriesSubData: [
      {
  ...
  },
  {
    ...
    description1:
      ...
      descriptionMobile:"The financial sector is in an era where it demands innovation, so it can keep pace with the current fast technology. We provide exclusive web and app development services that cater to problems faced by financial sectors and give them more power to simplify work processes while at the same time increasing their customer base and improving revenue. Having specialized approach and knowledge of financial technology, we focus on developing special mobile and web apps for banking institutions, insurance firms, financial tech startups among other financial organizations; our team consists of experienced programmers who follow client objectives and goals delivering powerful, guarded, scalable answers that match their expectations.",
      description2:
      "Our custom retail & Health Care services help elevate your CX.",
    industriesSubData: [
      {
