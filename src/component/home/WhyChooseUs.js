...
const WhyChooseUs = () => {
  ...
  return (
    <>
      <div className="why-choose-use-section mt-10" id="whiye">
                                ...
                                <ul className="why-choose-list">
                                    ...
                                    <li>
                                        <div className='ct'>
                                            ...
                                            <h5 className="heading-h5">Innovative Product Engineering</h5>
                                        </div>
                                        <p className="para mt-1">Leveraging cutting-edge technologies, we engineer products that drive innovation and surpass industry standards.</p>
                                    </li>
                                    <li>
                                        <div className='ct'>
                                            <div className="icons">
                                            ...
                                            <h5 className="heading-h5">Seamless Digital Transformation</h5>
                                        </div>
                                        <p className="para mt-1">With our expertise, embark on a journey of digital transformation, seamlessly integrating technology to elevate your business to new heights.</p>
                                    </li>
                                </ul>
                            </div> */}
      ...
      {/* Projects Completed */}
      {/* <div className="container-section">
                <div className="fact-counter-section">
                    <div className="inner-box">
                        <div className="icons">
                            <FaUserFriends />
                        </div>
                        <div className='flex fact-count flex-col justify-center items-center mt-3'>
